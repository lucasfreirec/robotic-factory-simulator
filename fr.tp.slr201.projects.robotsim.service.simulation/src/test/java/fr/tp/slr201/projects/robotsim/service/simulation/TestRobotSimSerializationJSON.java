...
public class TestRobotSimSerializationJSON {
    ...
    public TestRobotSimSerializationJSON() {
        ...
        final FactoryPathFinder jgraphPahtFinder = new JGraphTDijkstraFactoryPathFinder(myFactory, 5);
        final Robot robot1 = new Robot(myFactory, jgraphPahtFinder, new CircularShape(5, 5, 2), new Battery(10), "Robot 1");
        ...
        robot2.addTargetComponent(new Conveyor(myFactory, conveyorShape, "Conveyor 1"));
    }
    
    @org.junit.jupiter.api.Test
    public void testSerialization() throws com.fasterxml.jackson.core.JsonProcessingException {
        String jsonResult = objectMapper.writeValueAsString(myFactory);
        
        LOGGER.info("JSON generated: " + jsonResult);
        
        Factory factoryDeserialized = objectMapper.readValue(jsonResult, Factory.class);
        
        if (factoryDeserialized != null) {
        	LOGGER.info("Factory: " + factoryDeserialized.getName());
        	LOGGER.info("Components recovery: " + factoryDeserialized.getComponents().size());
        } else {
        	LOGGER.info("Error: factory is null");
        }
    }
}
